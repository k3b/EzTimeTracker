...
public class DateTimeMinuteSlider extends DateSlider {

	public DateTimeMinuteSlider(Context context, OnDateSetListener l,	Calendar calendar) {
		this(context, l, calendar, null, null);
	}
	
    public DateTimeMinuteSlider(Context context, OnDateSetListener l,	Calendar calendar, 
    		Calendar minDate, Calendar maxDate) {
        super(context, R.layout.datetimeminuteslider, l, calendar, minDate, maxDate);
    }
