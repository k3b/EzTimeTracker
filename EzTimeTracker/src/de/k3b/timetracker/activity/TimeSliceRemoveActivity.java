...
public class TimeSliceRemoveActivity extends FilterActivity {
    ...
    private void doRemove() {
        final int itemsDeleted = Factory.getInstance().createTimeSliceRepository(this).delete(this.filter);
    ...
    protected void onOkCLick() {
        final int count = Factory.getInstance().createTimeSliceRepository(this).getCount(this.filter);
