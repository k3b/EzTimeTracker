...
public class TimeSheetDetailListActivity extends BaseReportListActivity
     ...
     *
     * @param context          needed to start this activity from parent activity.
     * @param filter           customized filter that can be discarded after finish.
     * @param idOnOkResultCode value to be returned if closed with ok
     */
